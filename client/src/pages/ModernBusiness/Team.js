...
// import images
import MinhTrinhImg from '../../assets/images/client/MinhTrinhImg.jpg'
import SubbuVenkatImg from '../../assets/images/client/SubbuVenkatImg.jpg'
...
class Team extends Component { // PageTeam
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            candidates : [
                ...
                //     ]
                // },
                { id : 2, image : SubbuVenkatImg, name : "Subbu Venkat", designation : "Business Lead", salary : "1950", link : "",
                    socialIds : [
                        { icon : "facebook", link : "#" },
                        { icon : "instagram", link : "#" },
                        { icon : "twitter", link : "#" },
                    ...
                    description: "Operational and Business Expertise. Lean Six Sigma Black Belt with 15 years of Hospital Process Improvement Experience. "
                },
                { id : 3, image : MinhTrinhImg, name : "Minh Trinh", designation : "Technical Lead", salary : "2540", link : "",
                    socialIds : [
                        { icon : "facebook", link : "#" },
                        { icon : "instagram", link : "#" },
                        { icon : "twitter", link : "#" },
                    ...
                    description: "High School Sophomore with a string of award winning applications to his credit."
                },
            ...
            //     { id : 2, image : team2, name : "Subbu Venkat", designation : "Business Lead" },
            //     { id : 3, image : team3, name : "Minh Trinh", designation : "Technical Lead" },
                    ...
                    <Row >
                        <Col xs={12} className="text-center">
                            <div className="section-title mb-4 pb-2">
                                <h4 className="title">Meet our Team.</h4>
                            </div>
                        </Col>
                    </Row>
                                ...
                                this.state.candidates.map((candidate, key) =>
                                    <Col lg="3" md="6" key={key} className="mt-4 pt-2">
                                        <Card className="team text-center border-0">
                                                ...
                                                {/* Description- a title and description */}
                                                <CardBody className="py-3 px-0 content">
                                                    <h4 className="mb-0"><Link to={candidate.link} className="name text-dark">{candidate.name}</Link></h4>
                                                    <h6 className="mb-0">{candidate.designation}</h6>
