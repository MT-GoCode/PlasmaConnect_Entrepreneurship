                ...
                <header id="topnav" className="defaultscroll sticky">
                    <Container>
                        ...
                        <div className="buy-button">
                            <a href="/signupinfo" rel="noopener noreferrer" id="buyButton" className="btn btn-primary">Sign Up</a>
                        </div>
...
//  <a onClick={}>{navLink.title}</a> 
                            ...
                            <a href="https://1.envato.market/landrickreactjs" target="_blank" rel="noopener noreferrer" className="btn btn-primary">Sign Up</a>
                            </div>
                        </div>
                    </Container>
                </header>
